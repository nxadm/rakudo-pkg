...
ENV LANG='C.UTF-8' \
    ...
    to_patch='/usr/lib/ruby/gems/2.4.0/gems/fpm-*/lib/fpm/package/apk.rb'
...
RUN set -xv ; \
    ...
    gem install --no-doc --no-ri fpm json && \
